//------------------------------------------------------------------------------
// Title: Scallop Segmentation Simulation
// Author: Matthew Dawkins
// Description: main.cpp, launches simple ui for running scallop tests
//------------------------------------------------------------------------------
...
int main( int argc, char** argv )
{
  ...
  cout << endl;
  cout << "~~~~~~~~SCALLOP DETECTOR V1.3.0~~~~~~~~" << endl;
  cout << endl;
  cout << "           _.-''|''-._ " << endl;
  cout << "        .-'     |     `-.       __\\" << endl;
  cout << "      .'\\       |       /`. _  (..)\\" << endl;
  ...
  if( argc == 4 || argc == 5 ) {
    ...
    if( settings.IsInputDirectory && !(settings.IsTrainingMode && settings.UseMIPInput) )
    {
  ...
  // Count scallops!
  int count = DETECT_SCALLOPS( settings );
